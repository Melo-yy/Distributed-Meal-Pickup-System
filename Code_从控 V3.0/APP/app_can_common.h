...
#define	MY_SLAVE_ID	              SLAVE_2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       			//定义本机id，其余无需
...
#define CMD_ORDER_ACK          		0x5B    // 主机订单确认命令
// ================== 取件成功命令 ==================
...
typedef enum {
    ...
    CAN_STATUS_HW_ERROR,         // 硬件错误
		CAN_STATUS_NOT_ALLOWED,			 // 主机拒绝连接
		CAN_STATUS_INVALID_STATE		 // 无效状态
} can_status_t;
